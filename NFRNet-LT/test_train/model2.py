...
#         self.conv3 = nn.Conv2d(1, NUM_FILTERS, (5, EMBEDDING_DIM))
...
#         out4 = self.conv_and_pool(self.conv4, out)
...
class TextCNN(nn.Module):
    def __init__(self):
        ...
        self.convs = nn.ModuleList([nn.Conv2d(1, NUM_FILTERS, (i, EMBEDDING_DIM)) for i in FILTER_SIZES2])
...
if __name__ == '__main__':
    model = TextCNN()
    input = torch.randint(0, 20000, (2, TEXT_LEN))
